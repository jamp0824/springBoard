...
<body>
	...
	<form id="boardForm"  action="./freeBoardInsertPro.ino">
		...
		<div style="width: 500px; float: left;" align="left"><input type="text" name="title"  value="${freeBoardDto.title }" readonly="readonly"/></div>
		...
		<div style="width: 500px; float: left;" align="left"><textarea name="content" rows="25" cols="65"  readonly="readonly">${freeBoardDto.content }</textarea></div>
		<div align="right">
	...
	<script type="text/javascript">
		...
		function modifyBtn(num) {
			...
			$("#boardForm").attr("action", "./freeBoardModify.ino");
